...
export declare class IfcManager extends IfcComponent {
     ...
     */
    pickIfcItem: (focusSelection?: boolean, duration?: number | undefined) => Promise<{
        modelID: number;
        id: number;
    } | null>;
    /**
     ...
     * @duration The length of the perspectiveCamera animation in seconds
     */
    highlightIfcItem: (focusSelection?: boolean, duration?: number | undefined) => Promise<{
        modelID: number;
        id: number;
    } | null>;
    /**
     ...
     * @id Express ID of the item.
     */
    pickIfcItemsByID: (modelID: number, ids: number[], focusSelection?: boolean, duration?: number | undefined) => void;
    prepickIfcItemsByID: (modelID: number, ids: number[], focusSelection?: boolean, duration?: number | undefined) => void;
    highlightIfcItemsByID: (modelID: number, ids: number[], focusSelection?: boolean, duration?: number | undefined) => void;
    unpickIfcItems: () => void;
     ...
     */
    setModelTranslucency(modelID: number, translucent: boolean, opacity?: number, selectable?: boolean): void;
    private addIfcModel;
